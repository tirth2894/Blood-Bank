    ...
    <div x-data="setup()">
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white text-black">
            ...
            <div class="h-full ml-14 mb-10 md:ml-64">
                        ...
                        <div class="rounded-t mb-0 px-0 border-0">
                            <div class="flex flex-wrap items-center px-4 py-2">
                                ...
                                <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                                    <button
                                        class="bg-blue-500 dark:bg-gray-100 text-white active:bg-blue-600  dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        ...
                        <form class="p-6 flex flex-col justify-center">
                            <div class="flex flex-col">
                                ...
                                <input type="name" name="name" id="name" placeholder="Full Name"
                                    class="w-100 mt-2 py-3 px-3 rounded-lg bg-white  border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />
                            </div>
                            ...
                            <button type="submit"
                                class="md:w-32 bg-blue-600 dark:bg-gray-100 text-white  font-bold py-3 px-6 rounded-lg mt-4 hover:bg-blue-500 dark:hover:bg-gray-200 transition ease-in-out duration-300">Submit</button>
                        </form>
                    </div>
                </div>
                <div class="mt-8 mx-4">
                    <div
                        class="p-4 bg-blue-50  dark:text-gray-50 border border-blue-500 dark:border-gray-500 rounded-lg shadow-md">
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 ">
                                    <tr class="bg-gray-50 hover:bg-gray-100 text-gray-700 ">
                                        ...
                                        <td class="px-4 py-3 text-sm">tirthrollwala@gmail.com</td>
                ...
                <!-- BLOOD BANKS -->
                <div class="mt-4 mx-4">
                    <h2 class="font-semibold my-5 text-secondary-dark text-red-600 text-xl">Blood Banks</h2>
                    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        <div class="w-full overflow-x-auto">
                            <table class="w-full">
                                <thead>
